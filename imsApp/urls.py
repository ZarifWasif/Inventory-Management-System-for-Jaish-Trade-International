...
from .views import generate_report_category
from .views import generate_inventory_pdf
from .views import generate_report_invoice
urlpatterns = [
    ...
    path('generate-report/', generate_pdf_view, name='generate_report'),
    path('generate-report-category/', generate_report_category, name='generate_report_category'),
    path('generate-inventory-report/', generate_inventory_pdf, name='generate_report_inventory'),
    path('generate-report-invoices/', generate_report_invoice, name='generate_report_invoices'),
