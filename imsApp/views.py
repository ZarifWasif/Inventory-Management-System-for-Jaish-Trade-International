...
#PF Generation of Inventory
def generate_inventory_pdf(request):
    products = Product.objects.all()  # Fetch all products from the database
    template_path = 'inventory_pdf_template.html'
...
#PDF Generator of Invoice
def generate_report_invoice(request):
    invoices = Invoice.objects.all()  # Fetch all invoices from the database
...
#PDF Generator of product
def generate_pdf_view(request):
    products = Product.objects.all()  # Fetch all products from the database
    template_path = 'pdf_template.html'
    context = {'products': products}  # Correct context variable name
    response = HttpResponse(content_type='application/pdf')
...
#pdf generation of categories
def generate_report_category(request):
    categories = Category.objects.all()  # Fetch all categories from the database
    template_path = 'category_pdf_template.html'
